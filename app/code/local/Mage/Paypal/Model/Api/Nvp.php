...
//    protected $_manageRecurringPaymentsProfileStatusResponse = array('PROFILEID');
    ...
    public function callDoExpressCheckoutPayment()
    {
        ...
        $this->_exportLineItems($request);
	    //Vuelvo a informar el total del pedido para la confirmación del pago por que la request llega a 0 con las hamburguesas
        $request['AMT'] = (float) Mage::getModel('checkout/session')->getQuote()->getData()['grand_total'];
