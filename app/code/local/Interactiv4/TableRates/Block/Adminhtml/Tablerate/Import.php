 ...
 * @author davidslater
 */
class Interactiv4_TableRates_Block_Adminhtml_Tablerate_Import extends Mage_Adminhtml_Block_Widget_Form_Container {
    public function __construct() {
        ...
        $this->_mode = 'import';
        parent::__construct();
        $this->_updateButton('save',  'label', Mage::helper('i4tablerates')->__('Import'));
