<?php
class Interactiv4_TableRates_Block_Adminhtml_Tablerate_Grid extends Mage_Adminhtml_Block_Widget_Grid {
    /**
     *
     * @var array 
     */
    ...
    public function __construct() {
        ...
        $this->setId('i4tablerates_tablerateGrid');
    ...
    protected function _prepareCollection() {
        $collection = Mage::getModel('i4tablerates/tablerate')->getCollection();
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('website', array(
            ...
            'default' => '',
            'type' => 'options',
            'options' => Mage::getSingleton('i4tablerates/source_website')->getWebsites(),
        ...
        $this->addColumn('dest_region', array(
            ...
            'filter' => 'i4tablerates/adminhtml_widget_grid_column_filter_region',
            'default' => '*',
        ));
        ...
        $this->addColumn('shipping_price', array(
            ...
            'filter_index' => "main_table.{$this->_map['price_percentage']}",
            'type' => 'price',
            'currency_code' => $store->getBaseCurrency()->getCode(),
            'default' => '',
        ));
    ...
    /**
     *
     * @param Interactiv4_TableRates_Model_Mysql4_Tablerate_Collection $collection
     * @param type Mage_Adminhtml_Block_Widget_Grid_Column
     * @return \Interactiv4_TableRates_Block_Adminhtml_Tablerate_Grid 
     */
     ...
     * @return \Interactiv4_TableRates_Block_Adminhtml_Tablerate_Grid 
     */
    protected function _weightPriceAndAboveFilter(Interactiv4_TableRates_Model_Mysql4_Tablerate_Collection $collection, Mage_Adminhtml_Block_Widget_Grid_Column $column, $priceVsDest = false) {
