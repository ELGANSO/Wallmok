...
class Interactiv4_Integration_Block_Adminhtml_Renderer_Customer_Newsletter_Out extends Mage_Adminhtml_Block_System_Config_Form_Field_Array_Abstract
{
    ...
    protected function _getGroupRenderer()
    {
        if (!$this->_groupRenderer) {
            $this->_groupRenderer = $this->getLayout()->createBlock(
                'i4integration/adminhtml_form_field_customer_newsletter', '',
                array('is_render_to_js_template' => true)
            );
            $this->_groupRenderer->setClass('i4integration_customer_newsletter_select');
