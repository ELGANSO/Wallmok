...
class Interactiv4_Integration_Block_Adminhtml_Renderer_Customer_In extends Mage_Adminhtml_Block_System_Config_Form_Field_Array_Abstract
{
    ...
    public function __construct() {
	   parent::__construct();
        $this->setTemplate('i4integration/config/form/field/sync/customer/in.phtml');
    }
    ...
    protected function _getGroupRenderer()
    {
        if (!$this->_groupRenderer) {
            $this->_groupRenderer = $this->getLayout()->createBlock(
                'i4integration/adminhtml_form_field_customer_attributes', '',
                array('is_render_to_js_template' => true)
            );
            $this->_groupRenderer->setClass('i4integration_customer_select');
