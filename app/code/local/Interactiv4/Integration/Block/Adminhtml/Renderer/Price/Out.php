...
class Interactiv4_Integration_Block_Adminhtml_Renderer_Price_Out extends Mage_Adminhtml_Block_System_Config_Form_Field_Array_Abstract
{
    ...
    public function __construct() {
	   parent::__construct();
        $this->setTemplate('i4integration/config/form/field/sync/price/out.phtml');
    }
    ...
    protected function _getGroupRenderer()
    {
        if (!$this->_groupRenderer) {
            ...
            $this->_groupRenderer->setClass('i4integration_price_select');
