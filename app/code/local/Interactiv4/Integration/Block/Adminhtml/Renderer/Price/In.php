...
class Interactiv4_Integration_Block_Adminhtml_Renderer_Price_In extends Mage_Adminhtml_Block_System_Config_Form_Field_Array_Abstract
{
    ...
    public function __construct() {
	   parent::__construct();
        $this->setTemplate('i4integration/config/form/field/sync/price/in.phtml');
    }
