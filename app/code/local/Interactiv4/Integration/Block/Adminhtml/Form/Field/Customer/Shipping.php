...
class Interactiv4_Integration_Block_Adminhtml_Form_Field_Customer_Shipping extends Mage_Core_Block_Html_Select
{
    ...
    protected function _getAttributes($attributeId = null)
    {
        if (is_null($this->_attributes)) {
            ...
            $collection = Mage::getModel('i4integration/system_config_source_customer_address')->toOptionArray();
