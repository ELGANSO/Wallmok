<?php
class Interactiv4_Mrw_Model_Mysql4_Carrier_Tablerate_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract
{
    /**
     * main table name
     *
    ...
    {
        $this->_init('i4mrwes/carrier_tablerate');
